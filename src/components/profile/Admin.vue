                ...
                <div v-if="bars" class="ml-4 mt-2 md:mt-0 pl-300 w-full">
                  <div class="flex justify-between">
                    ...
                    <div class="flex gap-4">
                      ...
                      <div v-if="showDelete" class="fixed top-0 left-0 right-0 bottom-0 flex items-center bg-opacity-25 justify-center bg-gray-100 bg-opacity-75 transition z-50">
                        <DeletePopup @close-event-delete="closeEventDelete" />
                      </div>
                    </div>
                  </div>
