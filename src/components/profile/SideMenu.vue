  ...
  >
    <ul class="flex md:flex-col justify-center mt-6">
      <li class="mb-6">
        <template v-if="userId">
          <router-link
            ...
            :class="{ 'active-link mr-4 md:mr-0 border-r-2 md:border-r-0 border-gray-400 md:border-logo-color pr-2 pl-2 md:pr-0': activeLink === 'account' }"
      ...
      <li v-if="userData.isAdmin">
        <a
          href="#"
          :class="{ 'active-link mr-4 md:mr-0 border-l-2 pr-0 md:pl-2  border-gray-400 md:border-logo-color pl-2  md:ml-0': activeLink === 'admin' }"
          class="text-m font-medium"
        >
        <router-link
              :to="{
